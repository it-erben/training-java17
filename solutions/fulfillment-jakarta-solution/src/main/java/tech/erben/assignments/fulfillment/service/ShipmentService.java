...
public class ShipmentService {
    ...
    public List<ShipmentSummary> listShipmentSummaries() {
        return entityManager.createQuery("""
                select new tech.erben.assignments.fulfillment.domain.projection.ShipmentSummary(
                    s.id,
                    s.status,
                    s.carrier,
                    s.trackingNumber,
    ...
    public ShipmentDetail getShipmentView(Long id) {
        return toShipmentDetail(getShipment(id));
    }
    ...
    public ShipmentDetail toShipmentDetail(Shipment shipment) {
        List<ShipmentItemView> itemViews = shipment.getItems().stream()
